...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'hero.sub': 'Bellandur Ganesha Utsava is a community Ganesha festival in Bellandur, known for one of the tallest and richest idols in the area. Run by the neighbourhood, for the neighbourhood, for ten years.',
      ...
      'when.d2title': 'Dance night',
      'when.d3title': 'Vocals and dance',
      'when.d4title': 'Camps and musical night',
      ...
      'slot.d1t1': '11:00 am',
      'slot.d1w1': 'Ganesha Pratishthapana',
      'slot.d1t2': '4:00 to 6:00 pm',
      'slot.d1w2': 'Bharatanatyam and western dance',
      'slot.d1t3': '6:00 pm',
      'slot.d1w3': 'Ganga aarti',
      'slot.d1t4': '7:00 pm',
      'slot.d1w4': 'Prasadam',
      'slot.d1t5': '7:00 to 10:00 pm',
      'slot.d1w5': 'Musical night and dance event',
      'slot.d2t1': '7:00 pm',
      'slot.d2w1': 'Prasadam',
      'slot.d2t2': '7:00 to 10:00 pm',
      'slot.d2w2': 'Nonstop dance event',
      'slot.d3t1': '4:00 to 6:00 pm',
      'slot.d3w1': 'Vocals and Bharatanatyam',
      'slot.d3t2': '7:00 to 10:00 pm',
      'slot.d3w2': 'Bharatanatyam and western dance',
      'slot.d4t1': '10:30 am',
      'slot.d4w1': 'Blood donation camp',
      'slot.d4t2': '10:30 am',
      'slot.d4w2': 'Medical camp',
      'slot.d4t3': '12:00 pm',
      'slot.d4w3': 'Mahadanam',
      'slot.d4t4': '7:00 pm',
      'slot.d4w4': 'Prasadam',
      'slot.d4t5': '7:00 to 10:00 pm',
      'slot.d4w5': 'Musical night',
      'slot.d5t1': '5:00 to 10:00 pm',
      'slot.d5w1': 'Procession',
      'slot.d5t2': '7:00 pm',
      'slot.d5w2': 'Prasadam',
      ...
      'fest.dTitle': 'Seva',
      'fest.dText': 'Pooja arrangements, the idol and the community seva are run under Bellandur Ganesha Utsava by Sri Vinayaka Seva Mandali and Classic Boys, and funded by the area itself.',

      'photos.eyebrow': 'Photos and videos',
      'photos.title': 'Where the pictures live.',
      'photos.lede': 'The festival is documented as it happens, by the organisers and by everyone who attends. These are the three places it all ends up.',
      ...
      'photos.igAria': 'Scan or open @bellandur_maharaja on Instagram',
      'photos.igCap': 'Scan to follow @bellandur_maharaja',
      'photos.igQrAlt': 'Instagram QR for @bellandur_maharaja',
      ...
      'vis.cText': 'Friday 18 September, from 5:00 pm. The route is posted on Instagram and Facebook closer to the day.',
      'band.title': 'One place. One street. <span class="stroke">Ten years running.</span>',
      'band.text': 'Sri Vinayaka Seva Mandali and Classic Boys came together as Bellandur Ganesha Utsava so the neighbourhood celebrates in one place, not on separate roads. Same organisers, same street, tenth year.',
      ...
      'visit.timingsB': 'Day one opens at 11:00 am with the pratishthapana. Evening programmes run to about 10:00 pm. The procession on day five starts at 5:00 pm.',
      ...
      'visit.updatedB': 'Follow bellandur_maharaja on Instagram, or the festival page on Facebook, for the procession route and anything that changes.',

      'about.eyebrow': 'About',
      'about.title': 'One place for the whole neighbourhood.',
      'about.portraitAlt': 'Bellandur Ganesha Utsava Kannada emblem',
      'about.caption': 'Bellandur Ganesha Utsava',
      'about.p1': 'Bellandur Ganesha Utsava is the festival organisation. Sri Vinayaka Seva Mandali and Classic Boys came together to start it as one shared festival in one place, instead of celebrating on separate roads. This is the tenth year in Bellandur.',
      'about.p2': 'The pandal, the idol, the pooja arrangements and the community seva are handled by the two groups and paid for by contributions from the area. There is no ticket, because the neighbourhood already funds it.',
      ...
      'seva.lede': 'Support Bellandur Ganesha Utsava with pooja arrangements, the idol and community seva. Scan the QR to pay by UPI, or use the VPA directly from your bank app.',
      ...
      'vol.title': 'Volunteer',
      'vol.text': 'The five days are run by people from the area. If you want to help with the pandal, the poojas or the procession, reach the organisers through Instagram or Facebook.',
      'vol.cta': 'Reach the organisers',
      ...
      'foot.fb': 'Facebook',
      'foot.res': 'Resources',
      'foot.copyright': '© 2026 Bellandur Ganesha Utsava.',
    ...
    kn: {
      ...
      'hero.sub': 'ಬೆಳ್ಳಂದೂರು ಗಣೇಶ ಉತ್ಸವ ಬೆಳ್ಳಂದೂರಿನ ಸಮುದಾಯ ಗಣೇಶ ಉತ್ಸವ. ಈ ಪ್ರದೇಶದ ಅತಿ ಎತ್ತರದ ಮತ್ತು ಸಂಪನ್ನ ಗಣೇಶ ಮೂರ್ತಿಗಳಲ್ಲಿ ಒಂದಕ್ಕೆ ಹೆಸರುವಾಸಿ. ಹತ್ತು ವರ್ಷಗಳಿಂದ ನೆರೆಹೊರೆಯವರಿಂದಲೇ ನಡೆಸಲಾಗುತ್ತಿದೆ.',
      'hero.ctaWhen': 'ಯಾವಾಗ',
      'hero.ctaDonate': 'ದಾನ',
      ...
      'when.d2title': 'ನೃತ್ಯ ರಾತ್ರಿ',
      'when.d3title': 'ಗಾಯನ ಮತ್ತು ನೃತ್ಯ',
      'when.d4title': 'ಶಿಬಿರಗಳು ಮತ್ತು ಸಂಗೀತ ರಾತ್ರಿ',
      ...
      'slot.d1t1': 'ಬೆಳಿಗ್ಗೆ ೧೧:೦೦',
      'slot.d1w1': 'ಗಣೇಶ ಪ್ರತಿಷ್ಠಾಪನೆ',
      'slot.d1t2': 'ಸಂಜೆ ೪:೦೦ ರಿಂದ ೬:೦೦',
      'slot.d1w2': 'ಭರತನಾಟ್ಯ ಮತ್ತು ಪಾಶ್ಚಾತ್ಯ ನೃತ್ಯ',
      'slot.d1t3': 'ಸಂಜೆ ೬:೦೦',
      'slot.d1w3': 'ಗಂಗಾ ಆರತಿ',
      'slot.d1t4': 'ಸಂಜೆ ೭:೦೦',
      'slot.d1w4': 'ಪ್ರಸಾದ',
      'slot.d1t5': 'ಸಂಜೆ ೭:೦೦ ರಿಂದ ರಾತ್ರಿ ೧೦:೦೦',
      'slot.d1w5': 'ಸಂಗೀತ ರಾತ್ರಿ ಮತ್ತು ನೃತ್ಯ ಕಾರ್ಯಕ್ರಮ',
      'slot.d2t1': 'ಸಂಜೆ ೭:೦೦',
      'slot.d2w1': 'ಪ್ರಸಾದ',
      'slot.d2t2': 'ಸಂಜೆ ೭:೦೦ ರಿಂದ ರಾತ್ರಿ ೧೦:೦೦',
      'slot.d2w2': 'ನಾನ್‌ಸ್ಟಾಪ್ ನೃತ್ಯ ಕಾರ್ಯಕ್ರಮ',
      'slot.d3t1': 'ಸಂಜೆ ೪:೦೦ ರಿಂದ ೬:೦೦',
      'slot.d3w1': 'ಗಾಯನ ಮತ್ತು ಭರತನಾಟ್ಯ',
      'slot.d3t2': 'ಸಂಜೆ ೭:೦೦ ರಿಂದ ರಾತ್ರಿ ೧೦:೦೦',
      'slot.d3w2': 'ಭರತನಾಟ್ಯ ಮತ್ತು ಪಾಶ್ಚಾತ್ಯ ನೃತ್ಯ',
      'slot.d4t1': 'ಬೆಳಿಗ್ಗೆ ೧೦:೩೦',
      'slot.d4w1': 'ರಕ್ತದಾನ ಶಿಬಿರ',
      'slot.d4t2': 'ಬೆಳಿಗ್ಗೆ ೧೦:೩೦',
      'slot.d4w2': 'ವೈದ್ಯಕೀಯ ಶಿಬಿರ',
      'slot.d4t3': 'ಮಧ್ಯಾಹ್ನ ೧೨:೦೦',
      'slot.d4w3': 'ಮಹಾದಾನಂ',
      'slot.d4t4': 'ಸಂಜೆ ೭:೦೦',
      'slot.d4w4': 'ಪ್ರಸಾದ',
      'slot.d4t5': 'ಸಂಜೆ ೭:೦೦ ರಿಂದ ರಾತ್ರಿ ೧೦:೦೦',
      'slot.d4w5': 'ಸಂಗೀತ ರಾತ್ರಿ',
      'slot.d5t1': 'ಸಂಜೆ ೫:೦೦ ರಿಂದ ರಾತ್ರಿ ೧೦:೦೦',
      'slot.d5w1': 'ಮೆರವಣಿಗೆ',
      'slot.d5t2': 'ಸಂಜೆ ೭:೦೦',
      'slot.d5w2': 'ಪ್ರಸಾದ',
      ...
      'fest.dTitle': 'ಸೇವೆ',
      'fest.dText': 'ಪೂಜಾ ವ್ಯವಸ್ಥೆ, ಮೂರ್ತಿ ಮತ್ತು ಸಮುದಾಯ ಸೇವೆಯನ್ನು ಬೆಳ್ಳಂದೂರು ಗಣೇಶ ಉತ್ಸವದಡಿ ಶ್ರೀ ವಿನಾಯಕ ಸೇವಾ ಮಂಡಲಿ ಮತ್ತು ಕ್ಲಾಸಿಕ್ ಬಾಯ್ಸ್ ನಿರ್ವಹಿಸುತ್ತಾರೆ, ಮತ್ತು ಈ ಪ್ರದೇಶವೇ ಹಣ ಒದಗಿಸುತ್ತದೆ.',

      'photos.eyebrow': 'ಫೋಟೋ ಮತ್ತು ವೀಡಿಯೊಗಳು',
      'photos.title': 'ಚಿತ್ರಗಳು ಎಲ್ಲಿವೆ.',
      'photos.lede': 'ಉತ್ಸವ ನಡೆಯುತ್ತಿರುವಂತೆಯೇ ಆಯೋಜಕರು ಮತ್ತು ಬಂದವರೆಲ್ಲ ದಾಖಲಿಸುತ್ತಾರೆ. ಎಲ್ಲವೂ ಸೇರುವ ಮೂರು ಸ್ಥಳಗಳು ಇವು.',
      'photos.albumAria': 'ಬೆಳ್ಳಂದೂರು ಗಣೇಶ ಉತ್ಸವ ಫೋಟೋ ಆಲ್ಬಮ್ ತೆರೆಯಿರಿ',
      'photos.albumCap': 'ಉತ್ಸವದ ಫೋಟೋ ಆಲ್ಬಮ್',
      'photos.albumWhere': 'Google Photos',
      'photos.igAria': 'Instagram ನಲ್ಲಿ @bellandur_maharaja ಸ್ಕ್ಯಾನ್ ಮಾಡಿ ಅಥವಾ ತೆರೆಯಿರಿ',
      'photos.igCap': '@bellandur_maharaja ಅನುಸರಿಸಲು ಸ್ಕ್ಯಾನ್ ಮಾಡಿ',
      'photos.igQrAlt': '@bellandur_maharaja Instagram QR',
      'photos.igWhere': 'Instagram',
      ...
      'vis.cText': 'ಶುಕ್ರವಾರ ೧೮ ಸೆಪ್ಟೆಂಬರ್, ಸಂಜೆ ೫:೦೦ ರಿಂದ. ಮಾರ್ಗವನ್ನು ದಿನದ ಹತ್ತಿರ Instagram ಮತ್ತು Facebook ನಲ್ಲಿ ಪ್ರಕಟಿಸಲಾಗುತ್ತದೆ.',
      'band.title': 'ಒಂದು ಸ್ಥಳ. ಒಂದು ಬೀದಿ. <span class="stroke">ಹತ್ತು ವರ್ಷಗಳಿಂದ.</span>',
      'band.text': 'ಶ್ರೀ ವಿನಾಯಕ ಸೇವಾ ಮಂಡಲಿ ಮತ್ತು ಕ್ಲಾಸಿಕ್ ಬಾಯ್ಸ್ ಬೆಳ್ಳಂದೂರು ಗಣೇಶ ಉತ್ಸವವಾಗಿ ಒಂದಾಗಿ, ಪ್ರತ್ಯೇಕ ಬೀದಿಗಳ ಬದಲು ಒಂದೇ ಸ್ಥಳದಲ್ಲಿ ಆಚರಿಸುತ್ತಾರೆ. ಅದೇ ಆಯೋಜಕರು, ಅದೇ ಬೀದಿ, ಹತ್ತನೇ ವರ್ಷ.',
      ...
      'visit.timingsT': 'ಸಮಯ',
      'visit.timingsB': 'ಮೊದಲ ದಿನ ಬೆಳಿಗ್ಗೆ ೧೧:೦೦ ಕ್ಕೆ ಪ್ರತಿಷ್ಠಾಪನೆಯಿಂದ ಆರಂಭ. ಸಂಜೆಯ ಕಾರ್ಯಕ್ರಮಗಳು ರಾತ್ರಿ ೧೦:೦೦ ರವರೆಗೆ. ಐದನೇ ದಿನದ ಮೆರವಣಿಗೆ ಸಂಜೆ ೫:೦೦ ಕ್ಕೆ ಆರಂಭ.',
      ...
      'visit.updatedB': 'ಮೆರವಣಿಗೆಯ ಮಾರ್ಗ ಮತ್ತು ಯಾವುದೇ ಬದಲಾವಣೆಗಳಿಗಾಗಿ Instagram ನಲ್ಲಿ bellandur_maharaja ಅಥವಾ Facebook ಪುಟವನ್ನು ಅನುಸರಿಸಿ.',

      'about.eyebrow': 'ಪರಿಚಯ',
      'about.title': 'ಇಡೀ ನೆರೆಹೊರೆಗೆ ಒಂದೇ ಸ್ಥಳ.',
      'about.portraitAlt': 'ಬೆಳ್ಳಂದೂರು ಗಣೇಶ ಉತ್ಸವ ಕನ್ನಡ ಲಾಂಛನ',
      'about.caption': 'ಬೆಳ್ಳಂದೂರು ಗಣೇಶ ಉತ್ಸವ',
      'about.p1': 'ಬೆಳ್ಳಂದೂರು ಗಣೇಶ ಉತ್ಸವವೇ ಉತ್ಸವದ ಸಂಸ್ಥೆ. ಶ್ರೀ ವಿನಾಯಕ ಸೇವಾ ಮಂಡಲಿ ಮತ್ತು ಕ್ಲಾಸಿಕ್ ಬಾಯ್ಸ್ ಪ್ರತ್ಯೇಕ ಬೀದಿಗಳಲ್ಲಿ ಆಚರಿಸುವ ಬದಲು ಒಂದೇ ಸ್ಥಳದಲ್ಲಿ ಒಂದೇ ಉತ್ಸವವಾಗಿ ಪ್ರಾರಂಭಿಸಿದರು. ಇದು ಬೆಳ್ಳಂದೂರಿನಲ್ಲಿ ೧೦ನೇ ವರ್ಷ.',
      ...
      'seva.lede': 'ಪೂಜಾ ವ್ಯವಸ್ಥೆ, ಮೂರ್ತಿ ಮತ್ತು ಸಮುದಾಯ ಸೇವೆಗೆ ಬೆಳ್ಳಂದೂರು ಗಣೇಶ ಉತ್ಸವಕ್ಕೆ ಬೆಂಬಲಿಸಿ. UPI ಮೂಲಕ ಪಾವತಿಸಲು QR ಸ್ಕ್ಯಾನ್ ಮಾಡಿ, ಅಥವಾ ನಿಮ್ಮ ಬ್ಯಾಂಕ್ ಆ್ಯಪ್‌ನಲ್ಲಿ VPA ಬಳಸಿ.',
      'seva.upi': 'UPI: 9845111817@kbl',
      ...
      'vol.text': 'ಈ ಐದು ದಿನಗಳನ್ನು ಈ ಪ್ರದೇಶದ ಜನರೇ ನಡೆಸುತ್ತಾರೆ. ಪಂದಾಲ್, ಪೂಜೆ ಅಥವಾ ಮೆರವಣಿಗೆಯಲ್ಲಿ ಸಹಾಯ ಮಾಡಲು Instagram ಅಥವಾ Facebook ಮೂಲಕ ಆಯೋಜಕರನ್ನು ಸಂಪರ್ಕಿಸಿ.',
      'vol.cta': 'ಆಯೋಜಕರನ್ನು ಸಂಪರ್ಕಿಸಿ',
      ...
      'foot.copyright': '© ೨೦೨೬ ಬೆಳ್ಳಂದೂರು ಗಣೇಶ ಉತ್ಸವ.',
      'pref.language': 'ಭಾಷೆ',
      'pref.theme': 'ಥೀಮ್',
