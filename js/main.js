(function () {
  ...
  var strings = {
    en: {
      ...
      "res.cherryEn": "Primary colour mark for dark backgrounds.",
      "res.cherryKn": "Primary Kannada colour mark.",
      "res.revTitle": "Reversed",
      "res.revBody": "For light or white surfaces.",
      "res.origTitle": "Original",
      "res.origBody": "Full original treatment with decorative dots.",
      "res.note":
    ...
    kn: {
      ...
      "res.cherryEn": "ಕತ್ತಲೆ ಹಿನ್ನೆಲೆಗೆ ಪ್ರಾಥಮಿಕ ಬಣ್ಣದ ಗುರುತು.",
      "res.cherryKn": "ಪ್ರಾಥಮಿಕ ಕನ್ನಡ ಬಣ್ಣದ ಗುರುತು.",
      "res.revTitle": "ವಿಲೋಮ",
      "res.revBody": "ಬಿಳಿ ಅಥವಾ ತಿಳಿ ಹಿನ್ನೆಲೆಗೆ.",
      "res.origTitle": "ಮೂಲ",
      "res.origBody": "ಅಲಂಕಾರಿಕ ಚುಕ್ಕೆಗಳೊಂದಿಗೆ ಪೂರ್ಣ ಮೂಲ ರೂಪ.",
      "res.note":
